...
public class BoardController {
	...
	public Board create(Board board) {
		...
		if(board.getBattach() !=null && !board.getBattach().isEmpty()) {
			...
			try {
			File file = new File("/Users/jeongminlee/Desktop/Temp/uploadfile/"+board.getBattachsname());
			mf.transferTo(file);
			}catch(Exception e) {
...
//	}
  ...
  public Board put(Board board) {
	...
	public ResponseEntity<InputStreamResource> download(@PathVariable int bno) throws Exception{
		...
		//파일 입력 스트림 생성
		FileInputStream fis = new FileInputStream("/Users/jeongminlee/Desktop/Temp/uploadfile/" + board.getBattachsname());
